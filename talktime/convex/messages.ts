...
export const get = query({
    ...
    handler: async (ctx, args) => {
        ...
        const mesagesWithUsers = Promise.all(messages.map(async message => {
            ...
            return {
                ...
                isCurrentUser: messageSender._id === currentUser._id, //bool render messade either is on right side or left side
            }
        }))

        return mesagesWithUsers;
    },
